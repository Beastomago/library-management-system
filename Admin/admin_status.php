...
<div class="container">
	...
	<div style="float: right;" class="srch">
		<form class="navbar-form" method="post" name="form1">
				...
				<input class="form-control" type="text" name="search" placeholder=" New request username.." required="">
	...
	<br><br><br><br><br><h2>New Request</h2>
	<?php
        ...
        <button type="submit" name="submit2" style="background-color: #101010ed; color: white; font-weight: 700; font-size: 18px;" class="btn btn-default"><span style="color: green" class="glyphicon glyphicon-ok-sign"></span>&nbsp Approve</button>
        </form>
        <?php
        ...
        {
            mysqli_query($db,"UPDATE `admin` SET `status` = 'yes' where `admin`.`username` = '$_SESSION[test_name]';");
            unset($_SESSION['test_name']);
        }
