...
<?php
		...
		$sql = "SELECT * FROM books WHERE bid= $idss";
...
<!--         <input type="text" name="bid" class="form-control" placeholder="Book id" required=""><br>
 -->        <input type="text" name="name" class="form-control" value="<?php echo $name; ?>"><br>
        <input type="text" name="authors" class="form-control" value="<?php echo $authors; ?>"><br>
        <input type="text" name="edition" class="form-control" value="<?php echo $edition; ?>"><br>
        <input type="text" name="status" class="form-control" value="<?php echo $status; ?>"><br>
        <input type="text" name="quantity" class="form-control" value="<?php echo $quantity; ?>"><br>
        <input type="text" name="department" class="form-control" value="<?php echo $department; ?>"><br>
...
<?php
    if(isset($_POST['submit']))
    {
      if(isset($_SESSION['login_user1']))
      {
		...
		$sql2= "UPDATE `books` SET `bid`='$idss', `name`='$name', `authors`='$authors', `edition`='$edition', `status`='$status', `quantity`='$quantity', `department`='$department' WHERE `books`.`bid`= '$idss';";
...
function closeNav() {
  ...
  document.body.style.backgroundColor = "#DAE2F8";
}
</script>
